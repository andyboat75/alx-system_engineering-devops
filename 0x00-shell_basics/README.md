...
5-listfilesdigitonly - Display current directory contents in long format with gid and uid
...
16-clean-emacs - deleting all files in the current directory with ~ traillings
